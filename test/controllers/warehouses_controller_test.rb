...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { address: @warehouse.address, name: @warehouse.name, phone: @warehouse.phone, size: @warehouse.size }
    end
  ...
  test "should update warehouse" do
    patch :update, id: @warehouse, warehouse: { address: @warehouse.address, name: @warehouse.name, phone: @warehouse.phone, size: @warehouse.size }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
