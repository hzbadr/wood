...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { cost_price: @variant.cost_price, depth: @variant.depth, height: @variant.height, price: @variant.price, product_id: @variant.product_id, weight: @variant.weight, width: @variant.width }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { cost_price: @variant.cost_price, depth: @variant.depth, height: @variant.height, price: @variant.price, product_id: @variant.product_id, weight: @variant.weight, width: @variant.width }
    assert_redirected_to variant_path(assigns(:variant))
  end
