...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { account_number: @bank.account_number, name: @bank.name, type: @bank.type }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { account_number: @bank.account_number, name: @bank.name, type: @bank.type }
    assert_redirected_to bank_path(assigns(:bank))
  end
