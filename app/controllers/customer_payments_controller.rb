class CustomerPaymentsController < ApplicationController
  ...
  # GET /payments.json
  def index
    @search = @customer.payments.search(params[:q])
  ...
  def create
    ...
    respond_to do |format|
      if @payment.save
        format.html { redirect_to [@customer, @payment], notice: 'Payment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @payment.update(payment_params)
        format.html { redirect_to [@customer, @payment], notice: 'Payment was successfully updated.' }
