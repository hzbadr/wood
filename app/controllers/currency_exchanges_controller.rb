class CurrencyExchangesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @currency_exchange.save
        format.html { redirect_to @currency_exchange, notice: 'Currency exchange was successfully created.' }
  ...
  private
    ...
    def currency_exchange_params
      params.require(:currency_exchange).permit(:safe_id, :source_id, :source_amount, :destination_id, :destination_amount, :exchange_rate, :description)
    end
end
